...
import be.heh.EPMG7.EPMG7Application;
...
// RANDOM_PORT permet de faire fonctionné les tests en même temps que l'application
@SpringBootTest(classes = EPMG7Application.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class EmployeeControllerIntegrationTest {
    // injection des dépendances
    @Autowired
    private TestRestTemplate restTemplate;

    // injecte le port HTTP alloué lors de l'exécution, ici avec RANDOM_PORT un port libre non alloué par l'application EPMG7
    @LocalServerPort
    private int port;
    ...
    public void testCreateEmployee() {
        ...
        employeeModel.setName("admin42");
        employeeModel.setAddress("admin42");
